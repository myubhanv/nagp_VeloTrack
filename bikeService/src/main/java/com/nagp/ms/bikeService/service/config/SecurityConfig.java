package com.nagp.ms.bikeService.service.config;

import com.nagp.ms.bikeService.service.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                "/bikes/**",   // allow adding/updating bikes
